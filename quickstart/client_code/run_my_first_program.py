...
async def main():
    ...
    new_secret = nillion.NadaValues(
        {
            "weight_financial_health": nillion.SecretInteger(20),
            "weight_compliance":nillion.SecretInteger(50),
            "weight_operational_efficiency":nillion.SecretInteger(60),
            "weight_risk_management":nillion.SecretInteger(90),
        }
    )
    ...
    compute_bindings.add_input_party("Business", party_id)
    compute_bindings.add_input_party("Auditor", party_id)    
    compute_bindings.add_output_party("Business", party_id)

    # Add my_int2, the 2nd secret at computation time
    computation_time_secrets = nillion.NadaValues({
      "financial_health": nillion.SecretInteger(40),
      "compliance": nillion.SecretInteger(60),
      "operational_efficiency": nillion.SecretInteger(30),
      "risk_management": nillion.SecretInteger(70)
    })
